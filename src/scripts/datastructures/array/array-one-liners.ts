export namespace ArrayOneLiner {
    ...
    // Clone an array
    export const clone_1 = arr => arr.slice(0);
    export const clone_2 = arr => [...arr];
    export const clone_3 = arr => Array.from(arr);
    export const clone_4 = arr => arr.map(x => x);
    export const clone_5 = arr => JSON.parse(JSON.stringify(arr));
    export const clone_6 = arr => arr.concat([]);
     ...
     */
    export const countOccurrencesOf = (arr, val) => arr.reduce((a, v) => (v === val ? a + 1 : a), 0);
